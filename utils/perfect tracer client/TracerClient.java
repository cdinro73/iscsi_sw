...
public class TracerClient implements Runnable {
   ...
   public final static TracerClient tcpObj = new TracerClient();
   public final static String END_SESSION =
      new Character((char)0).toString(); // Indicates the end of a session

   // Connection atate info
   public static String hostIP = "192.168.200.135";
   public static int port = 1973;
   ...
   private static JPanel initOptionsPane() {
      ...
      JPanel optionsPane = new JPanel(new GridLayout(1, 1));//cdinu set 1,1 pt perfect

      // IP address input
      //pane = new JPanel(new FlowLayout(FlowLayout.RIGHT));
	  pane = new JPanel(new GridLayout (1 , 8 , 1 , 1)); 	
            ...
            public void actionPerformed(ActionEvent e) {
               if (connectionStatus != DISCONNECTED) {
                  ...
                  if (isHost) {
                     ...
                     ipField.setText("192.168.200.135");
                     hostIP = "192.168.200.135";
                  }
                  else {
                     ipField.setEnabled(true);
                  }
   ...
   private static void initGUI() {
      ...
      msgPane.add(chatTextPane, BorderLayout.CENTER);
      msgPane.setPreferredSize(new Dimension(200, 200));

      // Set up the main pane
      JPanel mainPane = new JPanel(new BorderLayout());
      mainPane.add(statusBar, BorderLayout.SOUTH);
      mainPane.add(optionsPane, BorderLayout.NORTH);
      mainPane.add(msgPane, BorderLayout.CENTER);

      // Set up the main frame
      mainFrame = new JFrame("Tracer Client");
   ...
   public static void main(String args[]) {
      ...
      while (true) {
         ...
         case DISCONNECTING:
            out.print(END_SESSION); out.flush();
